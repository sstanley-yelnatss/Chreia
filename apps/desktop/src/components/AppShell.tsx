...
import { MessageSquarePlus, Plus, Home, CircleHelp } from "lucide-react";
...
export default function AppShell() {
  ...
  return (
    <div className="relative flex h-screen overflow-hidden bg-background text-foreground">
      ...
      <aside className="flex w-52 shrink-0 flex-col overflow-hidden border-r border-sidebar-border bg-sidebar">
